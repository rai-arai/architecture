...
directly affect how people interact with or use Arai. For underlying technical
architecture and tooling decisions, use the architecture decision record template
instead.
