...
<!--
This template documents technical and organisational decisions for Arai projects
under the Omnifi Foundation. Architecture decision records focus on underlying
architecture, development processes, tooling, and project structure. For
community-facing changes and feature proposals, use the comment template instead.
...
<!--
How does this affect other Arai projects or the broader Rai ecosystem?
