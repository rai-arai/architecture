# Contributing to Arai Architecture

This document explains how to submit architectural proposals for Arai.
...
This guide covers the project-specific details for Arai.
...
decisions — choices about how Arai is built and maintained.
...
changes that affect how people use Arai.
...
- Architecture decision records: `decisions/0001-use-wasmtime-for-agent-sandbox.md`
- Requests for comments: `comments/0001-agent-card-discovery-protocol.md`
...
When submitting a proposal, identify which parts of Arai are affected. The major
areas are:
